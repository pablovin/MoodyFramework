...
moodDataSetLocation = "*.pkl location" #Mood dataset folder
...
render.renderGameStatus(dataSet=dataSetLocation, intrinsicData=moodDataSetLocation, gamesToRender=gameToRender, createVideo=True)